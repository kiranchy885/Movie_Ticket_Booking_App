...
import { ArrowRight, ClockIcon, CalendarIcon  } from 'lucide-react'
...
const HeroSection = () => {
    ...
    return (
        <div className='flex flex-col items-start justify-center gap-5 px-6 md:px-16
        lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
         ...
         <p className='max-w-md text-gray-300'>In a post-apocalyptic world where cities ride on wheels
            and consume each other to survive, two people meet in London and try to stop a conspiracy. </p>
