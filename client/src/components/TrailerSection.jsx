...
const TrailerSection = () => {
    ...
    return (
        <div className='px-6 md:16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        <div className='group grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
            {dummyTrailers.map((trailer)=>(
                ...
                cursor-pointer' onClick={()=> setCurrentTrailer
                (trailer)}>
                    
                    <img src={trailer.image} alt="tailer" className='rounded-lg w-full
